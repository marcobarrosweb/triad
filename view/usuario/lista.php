...
<script type="text/javascript" language="javascript" >
    $(document).ready(function () {
        ...
        var dataTable = $('#employee-grid').DataTable({
            ...
            "ajax": {
                url: "apiPrivada.php?class=UsuarioModel&method=listagem", // json datasource
        ...
        <div class="span12">
            <div class="box ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="?inc=view/usuario/novo"><div class="btn btn-info btn-cons"> Incluir Usuário</div></a>
                    </div>
                </div>
